...
/**
 * BUZZCHECK 1.0 - Perfect Pour Overhaul
 * - "Perfect Pour": Randomized target line, gradient scoring (proximity based).
 */
...
// ------------------------------------------------------------------
// BIG VS SMALL (REWRITTEN)
// ------------------------------------------------------------------

const BigVsSmall = ({ onFinish }) => {
  const [round, setRound] = useState(1);
...
// 17. THE LINE (Canvas Version - FIXED HEALTH SYSTEM)
const TheLine = ({ onFinish }) => {
...
// 19. SPIN CYCLE (Timing - FIXED VISUAL GLITCH)
const SpinCycle = ({ onFinish }) => {
...
// 21. RED LIGHT (Reaction - FIXED LOOP)
const RedLight = ({ onFinish }) => {
...
// REFACTORED: PERFECT POUR WITH GRADIENT SCORING & RANDOM TARGET
const PerfectPour = ({ onFinish }) => {
...
// 25. CATCH THE UBER (Arcade - FIXED VISIBILITY & LOGIC)
const CatchUber = ({ onFinish }) => {
...
const App = () => {
  ...
  const GAMES = [
    { id: 'balance', name: 'Hold My Beer', color: 'text-neon-pink', Component: HoldMyBeer },
    { id: 'typing', name: 'Drunk Text', color: 'text-neon-blue', Component: DrunkText },
    { id: 'memory', name: 'Where\'s Keys?', color: 'text-neon-purple', Component: WheresMyKeys },
    { id: 'reflex', name: 'Taco Run', color: 'text-neon-green', Component: TacoRun },
    { id: 'math', name: 'Tip Math', color: 'text-yellow-400', Component: TipCalculator },
    { id: 'stroop', name: 'Vibe Check', color: 'text-red-500', Component: VibeCheck },
    { id: 'pizza', name: 'Pizza King', color: 'text-orange-500', Component: PizzaKing },
    { id: 'pong', name: 'Shot Pong', color: 'text-green-400', Component: ShotPong },
    { id: 'toilet', name: 'Toilet Rush', color: 'text-blue-300', Component: ToiletRush },
    { id: 'uber', name: 'Uber Code', color: 'text-purple-400', Component: UberCode },
    { id: 'alphabet', name: 'Alphabet Soup', color: 'text-yellow-200', Component: AlphabetSoup },
    { id: 'bigsmall', name: 'Big vs Small', color: 'text-white', Component: BigVsSmall },
    { id: 'bouncer', name: 'The Bouncer', color: 'text-blue-500', Component: TheBouncer },
    { id: 'ghost', name: 'Ghost Toast', color: 'text-pink-500', Component: GhostToast },
    { id: 'clock', name: 'Internal Clock', color: 'text-gray-300', Component: InternalClock },
    { id: 'extext', name: 'Text Your Ex', color: 'text-red-600', Component: TextYourEx },
    { id: 'line', name: 'The Line', color: 'text-neon-blue', Component: TheLine },
    { id: 'reverse', name: 'Opposite Day', color: 'text-purple-400', Component: ReversePsych },
    { id: 'spin', name: 'Spin Cycle', color: 'text-green-400', Component: SpinCycle },
    { id: 'survival', name: 'Survival Mode', color: 'text-red-500', Component: SurvivalMode },
    { id: 'redlight', name: 'Red Light', color: 'text-yellow-400', Component: RedLight },
    { id: 'beer', name: 'Beer Goggles', color: 'text-blue-300', Component: BeerGoggles },
    { id: 'pour', name: 'Perfect Pour', color: 'text-yellow-500', Component: PerfectPour },
    { id: 'hydrate', name: 'Hydrate', color: 'text-blue-500', Component: Hydrate },
    { id: 'catch', name: 'Catch Uber', color: 'text-white', Component: CatchUber },
  ];
  ...
  return (
    <div className="min-h-screen bg-black font-sans text-white flex flex-col items-center justify-center p-4 overflow-hidden relative selection:bg-neon-pink selection:text-white">
      ...
      <style>{`.text-neon-pink{color:#ff00ff}.bg-neon-pink{background-color:#ff00ff}.text-neon-green{color:#39ff14}.bg-neon-green{background-color:#39ff14}.text-neon-blue{color:#00ffff}.bg-neon-blue{background-color:#00ffff}.text-neon-purple{color:#d946ef}.bg-neon-purple{background-color:#d946ef}@keyframes fade-in{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.animate-fade-in{animation:fade-in 0.5s ease-out forwards}@keyframes scale-in{from{opacity:0;transform:scale(0.9)}to{opacity:1;transform:scale(1)}}.animate-scale-in{animation:scale-in 0.3s cubic-bezier(0.175,0.885,0.32,1.275) forwards}@keyframes shake{0%{transform:translate(1px,1px) rotate(0deg)}10%{transform:translate(-1px,-2px) rotate(-1deg)}20%{transform:translate(-3px,0px) rotate(1deg)}30%{transform:translate(3px,2px) rotate(0deg)}40%{transform:translate(1px,-1px) rotate(1deg)}50%{transform:translate(-1px,2px) rotate(-1deg)}60%{transform:translate(-3px,1px) rotate(0deg)}70%{transform:translate(3px,1px) rotate(-1deg)}80%{transform:translate(-1px,-1px) rotate(1deg)}90%{transform:translate(1px,2px) rotate(0deg)}100%{transform:translate(1px,-2px) rotate(-1deg)}}.animate-shake{animation:shake 0.5s infinite}`}</style>
    </div>
  );
};
